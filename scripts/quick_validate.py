#!/usr/bin/env python3
"""Quick validation script for skills - adapted from Anthropic's skill-creator"""
...
def validate_skill(skill_path):
    """Validate a skill following Anthropic's specifications"""
    ...
    if description:
        ...
        if len(description) > 1024:
            return False, f"Description too long ({len(description)} chars). Maximum is 1024 characters"
